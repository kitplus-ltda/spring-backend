...
public class CustomerUtil {
    ...
    public static CustomerRequest createCustomerRequest(CustomerRequestMP customer, String type) {
        return CustomerRequest.builder()
                ...
                .address(
                        CustomerAddressRequest.builder()
                                ...
                                .streetNumber(Integer.parseInt(customer.getAddress().getStreetNumber()))
                                .build())
